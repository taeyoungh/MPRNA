---
title: 'MPRNA QC: Representation of oligos'
output:
  html_document:
    keep_md: true
---
...
![](representation_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
count.table$tileID <- oligoPool.design$tileID[idx]
```

### Number of barcodes that have 0 count
#### Plot
...
![](representation_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
colored by gene
...
### Number of barcodes that have counts more than 10
#### Plot
...
![](representation_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
- colored by gene
